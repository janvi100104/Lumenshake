...
## Step 1: Install Soroban CLI (5-10 minutes)

```bash
# Method 1: Via Cargo (Recommended)
cargo install soroban-cli

# Method 2: Install stellar-cli (includes soroban)
cargo install stellar-cli

# Method 3: Use Docker (No installation needed)
docker run stellar/soroban-cli --version

# Verify installation (after cargo install completes)
soroban --version
# OR
stellar --version
```

**Note**: The old install.sh script is deprecated. Use cargo install instead.
